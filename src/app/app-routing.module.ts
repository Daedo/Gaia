...
import { OrbitBuilderMainComponent } from './modules/orbit-builder/components/orbit-builder-main/orbit-builder-main.component';
...
const routes: Routes = [
  ...
  { path: 'orbits', component: OrbitBuilderMainComponent},
